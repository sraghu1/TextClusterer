 ...
 * @param stopWordFlag
 */
public void runAlgorithm(String path, boolean stemFlag, boolean stopWordFlag)
{
...
public void runAlgorithm(String path)
{
	...
	try
	{
	BufferedReader inputReader=new BufferedReader(new FileReader(new File(path+"/input.tsv")));
	if(path!=null)
	{
		BufferedWriter outputWriter=new BufferedWriter(new FileWriter(new File(path+"/output.tsv")));
